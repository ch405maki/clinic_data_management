<template>
    ...
    <AuthenticatedLayout>
      <template #header>
        <div class="flex justify-between items-center">
          <!-- Title -->
          <h2 class="font-semibold text-xl text-gray-800 leading-tight">Get Vitals</h2>
          <!-- Search Input -->
                        ...
                        <table class="min-w-full rounded-xl shadow-lg">
                          <thead>
                            <tr class="bg-gray-50">
                              ...
                              <th class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Email</th>
                              <th class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Role</th>
                            ...
                            >
                              ...
                              <td class="p-5">
                                <div class="flex items-center gap-1">
                                  <button @click="showUser(user.id)" class="p-2 text-indigo-500 ounded-full group transition-all duration-500 flex items-center">
                                    <!-- Edit Button -->
  ...
  const filteredUsers = computed(() => {
    return props.users.filter((user) =>
      [user.name, user.contact_no, user.email, user.role]
        .join(" ")
        .toLowerCase()
