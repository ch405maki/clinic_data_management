            ...
            <div class="max-w-7xl mx-auto">
                <div class="bg-white py-8 rounded-lg shadow grid grid-cols-1 gap-4 px-4 mt-2 sm:grid-cols-4 sm:px-8">
                    ...
                    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
                        ...
                        <div class="px-4 text-gray-700">
                            <h3 class="text-sm tracking-wider">Prescriptions</h3>
                                ...
                                <table class="min-w-full rounded-lg">
                                    ...
                                    <tbody class="divide-y divide-gray-300">
                                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                            ...
                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> Mark Manuel </td>
                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> +639971734770 </td>
                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> mark@mail.com </td>
                                            <td class=" p-5 ">
