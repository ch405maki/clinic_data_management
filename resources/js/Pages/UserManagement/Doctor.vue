<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold lg:text-xl md:text-lg text-sm text-gray-800 leading-tight">Doctor Management</h2>
        </template>
            ...
            <main class="flex-grow">
                <div class="max-w-7xl mx-auto">
                    <div class="flex flex-col md:flex-row w-full justify-center">
                        ...
                        <div class="w-full md:w-2/3 p-1 mt-2">
                                ...
                                <div class="min-w-full inline-block align-middle">
                                    <div class="overflow-hidden ">
                                        <table class=" min-w-full rounded-xl shadow-lg">
                                            <thead>
                                                <tr class="bg-gray-50">
                                                    <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-t-xl">Full Name</th>
                                                    ...
                                                    <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Role</th>
                                                    <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-t-xl"> Actions </th>
                                                </tr>
                                            </thead>
                                            <tbody class="divide-y divide-gray-300 ">
                                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50" v-for="(user, index) in users" :key="user.id">
                                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{ user.name }}</td>
                                                    <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{ user.contact_no || 'N/A' }}</td>
                                                    ...
                                                    <td class=" p-5 ">
                                                        <div class="flex items-center gap-1">
                                                            ...
                                                            <button @click="deleteUser(user.id, user.name)" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
                        ...
                        <div class="w-full md:w-1/3 p-2 flex justify-start">
                            <form @submit.prevent="submitForm" class="w-full bg-white p-5 rounded-lg">
                                ...
                                <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-12">
                                    ...
                                    <!-- Position Input -->
                                    <div class="sm:col-span-12">
                                        <InputLabel for="position" value="Doctor Specialty" />
                                        <TextInput
                                            id="position"
